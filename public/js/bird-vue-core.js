...
;(function (Vue, BIRD_CONFIG, U) {
  ...
  const _TRANSLATIONS = {
    fr: {
      ...
      notif_channel:'Canal de notification', notif_on:'Notifications actives', notif_off:'Notifications désactivées', notif_save:'Sauvegarder', notif_test:'Tester', notif_rare:'Espèce rare', notif_rare_desc:'Jamais vue ou moins de N détections au total', notif_season:'Première de saison', notif_season_desc:'Pas vue depuis N jours', notif_new:'Nouvelle espèce — Jamais détectée', notif_daily:'Première du jour', notif_daily_warn:'bruyant : ~50 notifs/jour', notif_each:'Chaque détection', notif_each_warn:'très bruyant : ~1000+ notifs/jour', notif_report:'Rapport hebdomadaire',
      ...
      retention_days:'Rétention audio (jours)', terminal_desc:'Bash — supporte Claude Code',
    ...
    en: {
      ...
      retention_days:'Audio retention (days)', terminal_desc:'Bash — supports Claude Code',
    ...
    de: {
      ...
      retention_days:'Audio-Aufbewahrung (Tage)', terminal_desc:'Bash — unterstützt Claude Code',
    ...
    nl: {
      ...
      retention_days:'Audio bewaring (dagen)', terminal_desc:'Bash — ondersteunt Claude Code',
